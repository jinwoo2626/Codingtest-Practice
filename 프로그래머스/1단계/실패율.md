    ...
    public static int[] solution(int N, int[] stages) {
        ...
        for (int i = 1; i <= N; i++){
            ...
            if(person == 0){
                ...
                div = map.get(i) / person;
                person -= map.get(i);
                map.put(i, div);
            }
        }

        List<Map.Entry<Integer, Double>> listmap = new ArrayList<>(map.entrySet());

        listmap.sort((entry1, entry2) -> {
